...
def test_resolve_model_preference_maps_plain_gpt54_to_suffixed_family():
    discovered = ["openai/gpt-5.4-medium", "gpt-5.4-high"]

    assert resolve_model_preference("gpt-5.4", discovered) in discovered
...
def test_resolve_model_preference_maps_plain_gpt55_to_low_effort_family():
    discovered = ["openai/gpt-5.5-low", "gpt-5.5-xhigh"]

    assert resolve_model_preference("gpt-5.5", discovered) == "openai/gpt-5.5-low"
